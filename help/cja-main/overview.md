...
Customer Journey Analyticsを使用すれば、Analysis Workspace内のオンラインとオフラインのデータを、共通の顧客IDでつなぎ合わせる方法を制御できます。最終的には、顧客データセット全体でアトリビューション、セグメンテーション、フロー、フォールアウトなどを行うことができます。
...
<tr>
  <td>
    ...
    <div>
      <a href="visitor-id/understanding-how-customer-journey-analytics-uses-identity.md">
    <strong>Customer Journey AnalyticsでのIdの使用方法を理解</strong>
    </a>
    </div>
    <p>
   ...
   <td>
    ...
    <div>
      <a href="architecture/architecture-and-integrations-of-cja.md">
    <strong>Customer Journey Analyticsのアーキテクチャと統合機能</strong>
    </a>
    </div>
    <p>
