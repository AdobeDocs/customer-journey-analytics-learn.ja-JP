...
+ [チャネル間のビジュアライゼーションの作成](/help/creating-cross-channel-visualizations-in-customer-journey-analytics.md)
+ [チャネル間アトリビューション](/help/cross-channel-attribution-in-customer-journey-analytics.md)
+ [Customer Journey Analyticsの計算指標の概要](/help/introduction-to-calculated-metrics-in-customer-journey-analytics.md)
+ [計算指標をAdobe AnalyticsからCustomer Journey Analyticsに移動する](/help/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.md)
