...
+ Data Insights Agent {#data-insights-agent}
  ...
  + [Microsoft 365 Copilotとの連携](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  ...
  + ビジュアライゼーション {#visualizations}
    ...
    + [テーブルとビジュアライゼーションのデータソース設定](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [折れ線グラフにトレンドラインを追加する](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [指標のスムージングに累積平均関数を使用する](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
...
+ コンポーネント {#components}
  ...
  + [リアルタイムのレポート](components/real-time-reporting.md)
  + ディメンション {#dimensions}
