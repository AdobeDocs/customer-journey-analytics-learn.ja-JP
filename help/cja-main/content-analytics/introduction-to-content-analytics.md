...
description: コンテンツのパフォーマンスの測定は困難なことがあり、多くの場合、推測や非効率につながります。 Content Analytics は、コンテンツを効果的にする要因に関する深いインサイトを提供することで、推測作業を排除します。
feature: Use Cases
role: Leader, User
level: Beginner
duration: 650
...
コンテンツのパフォーマンスの測定は困難なことがあり、多くの場合、推測や非効率につながります。 Content Analytics は、トーン、画像、カラー、メッセージなど、コンテンツを効果的にする要因に関する深いインサイトを提供することで、推測作業を排除します。 エンゲージメントを推進する要因や、コンテンツを最適化する方法など、重要な質問に回答します。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Content Analytics が Customer Journey Analytics および Experience Platform と連携する仕組みについて説明します。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Content Analytics - Create configuration">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="create-configuration.md" target="_blank" rel="referrer" title="Content Analytics - 設定の作成">Content Analytics – 設定の作成</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Content Analytics - Edit configuration">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="edit-configuration.md" target="_blank" rel="referrer" title="Content Analytics - 設定の編集">Content Analytics – 設定の編集</a>
                    </p>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Content Analytics が web サイトのコンテンツのパフォーマンスに関する詳細なレポートを提供する仕組みについて説明します。</p>
                </div>
