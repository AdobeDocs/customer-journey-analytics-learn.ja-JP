---
title: Customer Journey Analyticsをドリームホームとして理解する
description: 進化するビジネスニーズに対応するための新しい要件と能力を備えた、Customer Journey Analytics（CJA）を夢のマイホームとして捉える方法をご確認ください。
...
# Customer Journey Analyticsをドリームホームとして理解する
